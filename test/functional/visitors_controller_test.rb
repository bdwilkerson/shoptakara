...
class VisitorsControllerTest < ActionController::TestCase
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post :create, visitor: { email: @visitor.email, first: @visitor.first, name: @visitor.name, referral_source: @visitor.referral_source }
    end
  ...
  test "should update visitor" do
    put :update, id: @visitor, visitor: { email: @visitor.email, first: @visitor.first, name: @visitor.name, referral_source: @visitor.referral_source }
    assert_redirected_to visitor_path(assigns(:visitor))
  end
